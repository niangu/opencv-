...
#img = cv.imread('/home/niangu/桌面/答题卡识别/1.jpeg')
...
edged = cv.Canny(erosion, 50, 150, apertureSize=3)
cv.imwrite("Canny边缘检测.png", edged)
minLineLength = 100
maxLineGap = 10
...
"""
lines = cv.HoughLines(edged, 1, 0, 200)
for line in lines:
...
cv.namedWindow('Canny边缘检测2', cv.WINDOW_NORMAL)


cv.imshow("Canny边缘检测2", img)
